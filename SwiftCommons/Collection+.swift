...
public extension Collection where Iterator.Element: Equatable, IndexDistance == Int {
     ...
     */
    public func search<C: Collection, Result>(forContentsOf value: C, matched: (Index, inout Bool) -> Result) -> Result where C.Iterator.Element == Iterator.Element, C.IndexDistance == IndexDistance {
        var ret: Result? = nil
